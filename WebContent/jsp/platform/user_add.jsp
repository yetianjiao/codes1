		...
		<div class="span12">
			...
			<div class="block-fluid">
				<div class="row-form clearfix">
					...
					<div class="row-form clearfix">
                        <div class="span1">角色<font color="red">*</font></div>
                        <div class="span4">
                            <s:select list="roleList" name="user.role_id" listKey="id" listValue="name" cssClass="validate[required]"></s:select>
                        </div>
                        <div class="span1">帐户状态<font color="red">*</font></div>
                        <div class="span4">
                            <s:select list="userStatusList" name="user.user_state" listKey="code" listValue="name" cssClass="validate[required]"></s:select>
                        </div>
                    </div>
					...
					<div class="row-form clearfix">
						<div class="span12">
							<button class="btn btn-danger" type="button" onclick="add('User')">
								<span class="icon-ok icon-white"></span>&nbsp;&nbsp;提交
							</button>
							<button class="btn btn-warning" type="button" onclick="redirectPage('UserMgrListSearch.action')">
